 ...
 * 模型类
 *
 * @package    core* shopnc技术交流中心为你提供售后服务 以便你更好的了解
 */
class Model{
...
//            if(isset($pkValue)) $data[$pk]   =  $pkValue;
    ...
    public function get_pk() {
		//query('show columns from usc_web_homeview where `Key` = "PRI"')[0]['Field']
		$result = $this->query('show columns from ' . $this->table_prefix . $this->table_name . ' where `Key` = "PRI"');
		if ($result[0]['Field']) {
